...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_create_question(self):
        res = self.client().post('/questions', json={'question': 'Knock knock', 'answer': 'whos there', 'category': 3, 'difficulty':1})
        data = json.loads(res.data)
    ...
    def test_error_create_question(self):
        res = self.client().post('/questions/100', json={'question': 'Knock knock', 'answer': 'whos there', 'category': 3, 'difficulty':1})
        data = json.loads(res.data)
    ...
    def test_get_search_without_results(self):
        res = self.client().post('/questions/search', json={'searchTerm': 'zebra'})
        data = json.loads(res.data)
